    ...
    <div className="relative mx-auto flex w-full flex-col items-start justify-center sm:flex-row sm:items-center">
      ...
      >
        <path
          ...
          className="fill-violet-500 stroke-black dark:fill-neutral-300 dark:stroke-neutral-100"
          strokeWidth="3.445"
        />
        <path
      ...
      >
        <path
          ...
          className="fill-sky-400 stroke-black dark:fill-neutral-300 dark:stroke-neutral-100"
          strokeWidth="2.868"
        />
        <path
